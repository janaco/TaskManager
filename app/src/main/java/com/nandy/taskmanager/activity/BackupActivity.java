...
public class BackupActivity extends AppCompatActivity implements SettingsView{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        RestoreFromBackupModel restoreFromBackupModel = new RestoreFromBackupModel(getApplicationContext());
//        restoreFromBackupModel.setProgressListener(mPresenter);
        mPresenter.setRestoreDataModel(restoreFromBackupModel);
        GoogleDriveConnectionModel googleDriveConnectionModel = new GoogleDriveConnectionModel(this);
//        googleDriveConnectionModel.setGoogleDriveClientCallback(mPresenter);
        mPresenter.setGoogleDriveConnectionModel(googleDriveConnectionModel);
//        mPresenter.setmZipModel(new ZipModel(getApplicationContext()));
